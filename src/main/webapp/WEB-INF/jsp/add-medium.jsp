    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Medium Info</h2>
                    
                    <h2 class="title" style="color: green;">${success}</h2>
                    <h2 class="title" style="color: red;">${error}</h2>
                    <form:form method="POST" action="/save-medium" command="command">
                        <div class="input-group">
                            <form:input class="input--style-1" type="text" placeholder="MEDIUM NAME" path="mediumName"/>
                            <form:hidden path="id"/>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <form:input class="input--style-1" type="text" placeholder="MEDIUM CODE" path="mediumCode"/>
                                </div>
                            </div>
                        </div>
                        <div class="p-t-20">
